...
public class DataStreamJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Set parallelism để tránh overload CPU
        env.setParallelism(1);  // Giảm xuống 1 để tránh overload
        
        // Enable checkpointing để đảm bảo fault tolerance
        env.enableCheckpointing(30000); // checkpoint mỗi 30 giây để giảm tải
        ...
        JdbcExecutionOptions execOptions = new JdbcExecutionOptions.Builder()
                .withBatchSize(10000)  // Tăng batch size để giảm số lần write
                .withBatchIntervalMs(10000)  // Tăng interval lên 10 giây để giảm tần suất write
                .withMaxRetries(2)  // Giảm retry để tránh overload
                .build();
        ...
        transactionStream.sinkTo(
                new Elasticsearch7SinkBuilder<Transaction>()
                        ...
                        .setBulkFlushMaxActions(2000) // Tăng lên 2000 documents
                        .setBulkFlushMaxSizeMb(10) // Tăng lên 10MB
                        .setBulkFlushInterval(15000) // Tăng lên 15 giây
